            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex gap-1">
                {[1, 2, 3, 4, 5].map((star) => (
                  ...
                  >
                    <svg
                      className={`w-6 h-6 transition-colors ${star <= rating ? "text-yellow-400 fill-yellow-400" : "text-gray-300"}`}
                      viewBox="0 0 20 20"
                    >
        ...
        <div className="space-y-6">
          {reviews.map((review, index) => (
            <div
              ...
              className="bg-white border border-gray-100 p-5 rounded-xl shadow-sm transition-hover hover:shadow-md"
            >
